...
import type { State, PublicState, BBoardPrivateState, Contract, Witnesses } from '../../contract/src/index';
...
export type BBoardDerivedState = {
  ...
  readonly isPublic: PublicState;  
  readonly privateWeb: string | undefined;
